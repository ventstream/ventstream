...
state and selected configuration revision. Agents persist the last trusted desired
state and report observed state independently. This makes convergence auditable
and prevents an older gateway message from rolling an engine backward.

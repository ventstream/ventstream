...
The managed engine stages files atomically in a private configuration directory
and starts its pipeline child with `VS_ENGINE_CONFIG` pointing at the generated
`ventstream.yaml`.

...
infrastructure. It does not require the Fleet control plane, and with no agent
key it makes zero platform connections.
...
configuration, centralized pause/resume, and agent health require a
[Fleet-managed deployment](/fleet/overview).

...
<img
  src="/images/realtime-paths.svg"
  alt="A publisher writes to NATS or Redis Streams; the realtime engine fans out to raw WebSocket clients on :4040 /ws and Apollo clients on :4041 /graphql/ws."
